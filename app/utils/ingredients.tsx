...
export const unitConverter = (amt1: number, unit1: string, amt2: number, unit2: string) => {
  // console.log(UNIT_OF_MEASUREMENTS[unit2]);
}


const getMeasurementValue = (key: keyof UnitOfMeasurements) => {
